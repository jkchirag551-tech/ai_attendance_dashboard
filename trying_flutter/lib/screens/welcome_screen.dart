                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: Image.asset('assets/images/logo.png', width: 52, height: 52, fit: BoxFit.contain, errorBuilder: (_, __, ___) => const Icon(Icons.blur_on_rounded, size: 36, color: Colors.white)),
                            ),
